...
1. **Identify all unhappy agents** in vectorized format
2. **Generate candidate locations** for all unhappy agents in vectorized format
3. **Test happiness** at all candidate locations in vectorized format
