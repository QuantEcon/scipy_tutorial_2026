...
This tutorial explores simulation for economic analysis.
...
This tutorial focuses on Thomas Schelling's segregation model as our running example.
...
4. **Further vectorization** — How can we exploit modern parallel hardware (e.g., GPUs)
